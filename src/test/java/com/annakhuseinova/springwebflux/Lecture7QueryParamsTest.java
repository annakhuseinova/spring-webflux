...
public class Lecture7QueryParamsTest extends BaseTest{
    ...
    private static final String queryString = "http://localhost:8080/jobs/search?count={count}&page={page}";
    ...
    // You can alternatively set query params using the consumer of UriBuilder like below:
    @Test
    public void queryParamsAlternativeTest(){
        Flux<Integer> integerFlux = this.webClient
                .get()
    ...
    @Test
    public void queryParamsAlternativeTestWithMap(){
